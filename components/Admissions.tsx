    ...
    <section id="admissions" className="bg-[#1E3A1E] relative overflow-hidden border-t border-[rgba(248,246,241,0.05)] pt-16 md:pt-20">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-end justify-between gap-8">
          ...
          <div data-aos="fade-right" className="w-full md:w-7/12 text-center md:text-left pb-16 md:pb-24">
            <div className="relative inline-block mb-4 md:mb-6 mt-8 md:mt-0">
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(42px, 5vw, 64px)", fontWeight: 700, color: "#F8F6F1", lineHeight: 1.1, letterSpacing: "-0.01em" }}>
                Daftar <span className="italic">Sekarang</span>
              </h2>
            </div>

            <p className="mb-10 max-w-lg mx-auto md:mx-0" style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", fontWeight: 300, color: "rgba(248,246,241,0.85)", lineHeight: 1.6 }}>
            ...
            <Link href="/penerimaan" className="inline-flex items-center gap-3 group bg-[#B8960C] hover:bg-[#F8F6F1] text-[#1A2410] transition-colors duration-300 shadow-lg" style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", fontWeight: 600, padding: "14px 28px", borderRadius: "8px", textDecoration: "none" }}>
              Mulai Pendaftaran
          ...
          <div data-aos="fade-left" data-aos-delay="200" className="w-full md:w-5/12 flex justify-center md:justify-end">
            <img
              src="/admisss.png" 
