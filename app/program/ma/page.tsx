...
import { BookOpen, BriefcaseBusinessIcon } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#F8F6F1] flex flex-col">
      ...
      <section className="flex-grow pt-32 pb-24 px-8 md:pt-40">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 xl:gap-20 items-start">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-5 mb-8">
              <div className="w-14 h-14 shrink-0 rounded-full bg-[#B8960C]/20 flex items-center justify-center text-[#B8960C]">
                ...
                <BriefcaseBusinessIcon size={28} strokeWidth={2} fill="currentColor" className="opacity-80" />
              </div>
              <h1 
                className="uppercase"
                style={{ 
            ...
            >
              <p>
                Program Madrasah Aliyah (MA) di Pondok Pesantren Daarul Huda dirancang untuk memberikan fondasi yang kuat bagi santri dalam keunggulan akademik, karakter Islami, dan pertumbuhan pribadi selama masa transisi kedewasaan mereka.
              </p>
          ...
          {/* Kolom Kanan: Gambar */}
          <div className="w-full lg:w-1/2 mt-20 lg:mt-20">
            <img 
              // Ganti URL ini dengan foto asli santri MA pondokmu
              src="/program/amaliyahtad.png" 
              alt="Kegiatan Santri Madrasah Aliyah" 
