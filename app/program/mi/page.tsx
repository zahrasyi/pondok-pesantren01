          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-5 mb-8">
              <div className="w-14 h-14 shrink-0 rounded-full bg-[#B8960C]/20 flex items-center justify-center text-[#B8960C]">
                ...
                <BookOpen size={28} strokeWidth={2} fill="currentColor" className="opacity-80" />
              </div>
              <h1 
                className="uppercase"
                style={{ 
            ...
            >
              <p>
                Program Madrasah Ibtidaiyah (MI) di Pondok Pesantren Daarul Huda dirancang untuk memberikan fondasi yang kuat bagi santri dalam keunggulan akademik, karakter Islami, dan pertumbuhan pribadi selama masa transisi kedewasaan mereka.
              </p>
